...
print ycolumn
if(lines == 4){ 
	plot dataFile1 using 1:(column(ycolumn+0)) title title1, dataFile2 using 1:(column(ycolumn+0)) title title2, dataFile3 using 1:(column(ycolumn+0)) title title3, dataFile4 using 1:(column(ycolumn+0)) title title4 linetype 4
} else {
